...
const SignupForm = () => {
  ...
  let url;
  if (mode) url = "https://easyrooms.herokuapp.com/auth/signup";
  else url = "http://localhost:4000/auth/signup";
  ...
  return (
    <>
      <div className="signup_message_container">{message}</div>
      <div className="signup_form_container">
        ...
        <input
          ref={confirmPassword}
          className="signup_input confirm_password_input"
          type="password"
