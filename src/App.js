...
function App() {
  ...
  return (
    ...
    <Router>
      <Switch>
        <Route exact path="/"><LandingPage logoutHandler={logoutHandler}/></Route>
        <Route exact path="/add_room"><AddRoomPage /></Route>
        <Route exact path="/login"><LoginPage loggedIn={loginHandler}/></Route>
        <Route exact path="/signup"><SignupPage /></Route>
        <Route exact path="/food"><FoodPage /></Route>
        <Route exact path="/notes"><NotesPage /></Route>
        <Route exact path="/market"><MarketPage /></Route>
      </Switch>
    </Router>
