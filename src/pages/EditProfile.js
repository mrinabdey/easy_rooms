...
const EditProfile = (props) => {
  ...
  if (mode) url = `https://easyrooms.herokuapp.com/user/edit_profile`;
  else url = `http://localhost:4000/user/edit_profile`;
  ...
  return (
    <div className="profile-container">
      ...
      <div className="user-details-container">
        ...
        <label className="user-title-container contact">Contact Number:</label>
        <input
          className="user-detail-container"
          ref={contact}
          type="number"
          placeholder="9156899568"
        />
      </div>
